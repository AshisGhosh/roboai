...
async def _get_grasps_from_rgb_and_depth(rgb_image: Image, depth_image: Image) -> Dict[str, Any]:
    ...
    files = {'rgb_image': ('rgb_image.jpg', image_byte_array, 'image/jpeg'), 'depth_image': ('depth_image.jpg', depth_image_byte_array, 'image/jpeg')}
